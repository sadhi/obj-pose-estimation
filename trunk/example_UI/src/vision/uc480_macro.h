...
// UC480CAMEXP is_ImageFormat            (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ImageFormat)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_FaceDetection          (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(FaceDetection)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Focus                  (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Focus)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ImageStabilization     (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ImageStabilization)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ScenePreset            (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ScenePreset)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Zoom                   (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Zoom)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Sharpness              (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Sharpness)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Saturation             (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Saturation)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_TriggerDebounce        (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(TriggerDebounce)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ColorTemperature       (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ColorTemperature)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_HotPixel               (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(HotPixel)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_AOI                    (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(AOI)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Transfer               (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Transfer)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_IpConfig               (INT iID, UC480_ETH_ADDR_MAC mac, UINT nCommand, void* pParam, UINT cbSizeOfParam)
USB2CAMERA_MACRO_DO(IpConfig)
DECLARE(( INT iID, UC480_ETH_ADDR_MAC mac, UINT nCommand, void* pParam, UINT cbSizeOfParam ))

// UC480CAMEXP is_DeviceFeature          (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(DeviceFeature)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Configuration          (UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Configuration)
DECLARE(( UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Exposure               (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Exposure)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Trigger                (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Trigger)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_CaptureStatus          (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(CaptureStatus)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_BootBoost              (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(BootBoost)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_IO                     (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(IO)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_AutoParameter          (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(AutoParameter)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Convert                (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Convert)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ParameterSet           (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ParameterSet)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_EdgeEnhancement        (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(EdgeEnhancement)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_PixelClock             (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(PixelClock)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_DeviceInfo             (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(DeviceInfo)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ImageFile              (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(ImageFile)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Blacklevel             (HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Blacklevel)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_Measure				(HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
USB2CAMERA_MACRO_DO(Measure)
DECLARE(( HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam ))

// UC480CAMEXP is_ImageBuffer			(HCAM hf, UINT nCommand, void *pParam, UINT nSizeOfParam)
